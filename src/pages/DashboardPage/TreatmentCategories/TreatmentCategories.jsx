                        ...
                        <div className="dashboard-content-table">
                            <Row>
                                <div className="d-flex justify-content-between align-items-center listing-header">
                                    <h1 className="dashboard-content-title mb-0 h5 fw-bold default-font">Treatment Categories</h1>
                                    <button 
                            ...
                            <table className="table table-bordered">
                                ...
                                <tbody>
                                    {currentEntries.map((entry, index) => (
                                        <tr key={index}>
                                            <td>{entry.id}</td>
                                            <td><img src={entry.icon} alt="" className="img-fluid" /></td>
                                            <td>{entry.background}</td>
                                            <td>{entry.name}</td>
                                            <td>{entry.parentCategory}</td>
                                            <td>{entry.showAtHome ? "yes" : "no"}</td>
                                            <td>{entry.status}</td>
                                            <td>
                            ...
                            <div className="dashboard-all-listing-create-form">
                                <Row>
                                    <div className="d-flex justify-content-flex-start align-items-center listing-header">
                                        ...
                                        <h2 className="dashboard-all-listing-create-form-title mb-0 h5 fw-bold default-font text-capitalize">create treatment category</h2>
                                    </div>
                                </Row>
                                <hr />
                                        ...
                                        <Row>
                                            <Col xxl={6} xl={6} lg={6} md={6} sm={12}>
                                                <div className="form-group my-2">
                                                    <label htmlFor="bodyPicture" className="form-label text-capitalize fw-bold small">image icon <sup className="text-danger">*</sup></label>
                                            ...
                                            <Col xxl={6} xl={6} lg={6} md={6} sm={12}>
                                                <div className="form-group my-2">
                                                    <label htmlFor="showAtHome" className="form-label text-capitalize fw-bold small">show at home <sup className="text-danger">*</sup></label>
                                                    <select name="showAtHome" id="showAtHome" className="form-control text-capitalize" required>
                                            ...
                                            <Col xxl={12} xl={12} lg={12} md={12} sm={12}>
                                                <div className="form-group my-2">
                                                    <label htmlFor="parentCategory" className="form-label text-capitalize fw-bold small">Parent Treatment Category </label>
                                                    <input type="text" className="form-control" id="parentCategory" name="parentCategory" required />
                                                </div>
                                            </Col>
