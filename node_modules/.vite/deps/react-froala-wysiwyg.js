...
var require_react_froala_wysiwyg = __commonJS({
  "node_modules/react-froala-wysiwyg/index.js"(exports, module) {
    !function(t, e) {
      "object" == typeof exports && "object" == typeof module ? module.exports = e(require_react()) : "function" == typeof define && define.amd ? define(["react"], e) : "object" == typeof exports ? exports.index = e(require_react()) : t.index = e(t.React);
    }(exports, (t) => (() => {
      "use strict";
      var e = { 442: (e2) => {
        e2.exports = t;
      ...
      function r(t2) {
        ...
        var i2 = n[t2] = { exports: {} };
        return e[t2](i2, i2.exports, r), i2.exports;
      }
      r.n = (t2) => {
      ...
      function c(t2, e2, n2) {
        return (e2 = f(e2)) in t2 ? Object.defineProperty(t2, e2, { value: n2, enumerable: true, configurable: true, writable: true }) : t2[e2] = n2, t2;
      }
      function u(t2) {
      ...
      function l(t2, e2) {
        for (var n2 = 0; n2 < e2.length; n2++) {
          var r2 = e2[n2];
          r2.enumerable = r2.enumerable || false, r2.configurable = true, "value" in r2 && (r2.writable = true), Object.defineProperty(t2, f(r2.key), r2);
        }
      }
      function f(t2) {
        var e2 = function(t3) {
          if ("object" != u(t3) || !t3) return t3;
      ...
      function b(t2, e2) {
        for (var n2 = 0; n2 < e2.length; n2++) {
          var r2 = e2[n2];
          r2.enumerable = r2.enumerable || false, r2.configurable = true, "value" in r2 && (r2.writable = true), Object.defineProperty(t2, g(r2.key), r2);
        }
      }
      function g(t2) {
        var e2 = function(t3) {
          if ("object" != v(t3) || !t3) return t3;
          var e3 = t3[Symbol.toPrimitive];
          if (void 0 !== e3) {
            var n2 = e3.call(t3, "string");
      ...
      function O(t2) {
        return O = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function(t3) {
          return t3.__proto__ || Object.getPrototypeOf(t3);
        }, O(t2);
      }
      function j(t2, e2) {
      ...
      var E = function(t2) {
        function e2() {
          return function(t3, e3) {
            ...
            return e3 = O(e3), function(t4, e4) {
              if (e4 && ("object" == v(e4) || "function" == typeof e4)) return e4;
            ...
            }(t3, m() ? Reflect.construct(e3, n3 || [], O(t3).constructor) : e3.apply(t3, n3));
          }(this, e2, arguments);
        }
        return function(t3, e3) {
        ...
        } }]) && b(n2.prototype, r2), Object.defineProperty(n2, "prototype", { writable: false }), n2;
        var n2, r2;
      }(function(t2) {
        function e2(t3) {
          var n3;
          return function(t4, e3) {
            ...
            return e3 = d(e3), function(t5, e4) {
              if (e4 && ("object" == u(e4) || "function" == typeof e4)) return e4;
              if (void 0 !== e4) throw new TypeError("Derived constructors may only return object or undefined");
              return function(t6) {
                if (void 0 === t6) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                return t6;
              }(t5);
            }(t4, p() ? Reflect.construct(e3, n4 || [], d(t4).constructor) : e3.apply(t4, n4));
        ...
        return function(t3, e3) {
          ...
          var t3 = this;
          import("./froala_editor.min-GNMAPT3P.js").then(function(e3) {
            y = e3.default;
            var n3 = t3.el.tagName.toLowerCase();
          ...
          else if ("object" == u(t3)) if (t3.nodeType && "function" == typeof t3.cloneNode) e3 = t3.cloneNode(true);
          ...
          this.editorInitialized || this.editorCreated || (this.config = this.clone(this.props.config || this.config), this.config = function(t4) {
            for (var e3 = 1; e3 < arguments.length; e3++) {
              ...
              e3 % 2 ? s(Object(n3), true).forEach(function(e4) {
                c(t4, e4, n3[e4]);
              }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t4, Object.getOwnPropertyDescriptors(n3)) : s(Object(n3)).forEach(function(e4) {
          ...
          }, this.editor = new y(this.element, this.config), this.editorCreated = true);
        ...
        } }], r2 && l(n2.prototype, r2), Object.defineProperty(n2, "prototype", { writable: false }), n2;
        var n2, r2;
      }(a().Component));
      return o;
    })());
